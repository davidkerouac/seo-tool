...
export function Footer({ locale = 'en' }: FooterProps) {
    ...
    return (
        <footer className="bg-gradient-to-b from-[#fffdf8] to-[#fff5e6] border-t border-[#f5b842]/15 pt-16 pb-8">
            <div className="container mx-auto px-4 md:px-6">
                <div className="grid grid-cols-2 md:grid-cols-4 gap-8 mb-12">
                    <div className="col-span-2 md:col-span-1">
                        ...
                        <div className="space-y-2 mb-6">
                            <a href="mailto:david@silverroc.com" className="block text-sm text-[#8b7355] hover:text-[#5d4e42] transition-colors">
                                david@silverroc.com
                            </a>
                            <a href="tel:+6596665907" className="block text-sm text-[#8b7355] hover:text-[#5d4e42] transition-colors">
                                +65 9666 5907
                            </a>
                        </div>
                        <div className="flex gap-4">
                            <a href="#" className="text-[#b8a590] hover:text-[#f5b842] transition-colors">
                    ...
                    {Object.entries(footerLinks).map(([category, links]) => (
                        <div key={category}>
                            <h3 className="font-semibold text-[#5d4e42] mb-4">{category}</h3>
                                    ...
                                    <li key={link.name}>
                                        {link.external ? (
                                            <a
                                                ...
                                                className="text-sm text-[#8b7355] hover:text-[#f5b842] transition-colors"
                                            >
                                                {link.name}
                                            </a>
                                        ) : (
                ...
                <div className="border-t border-[#f5b842]/20 pt-8 flex flex-col md:flex-row justify-between items-center gap-4">
                    <p className="text-sm text-[#b8a590]">
                    ...
                    <div className="flex gap-6">
                        <a
                            ...
                            target="_blank"
                            rel="noopener noreferrer"
                            className="text-sm text-[#b8a590] hover:text-[#5d4e42] transition-colors"
                        >
                            {text.privacy}
                        </a>
                        <Link href="/terms" className="text-sm text-[#b8a590] hover:text-[#5d4e42] transition-colors">
                            {text.terms}
                        </Link>
                    </div>
                </div>
